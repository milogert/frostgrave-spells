...
const allSpellsNoId = [
  ...
  },
  {
    ...
    range: Ranges.LOS,
    outOfGame: false,
    description: "The spellcaster select and attacks a target's weapon, causing it to decay and fall apart, rendering it useless for the rest of the game. This spell has no effect on magic weapons (even those only temporarily enchanted).",
    starred: false,
  },
  {
    name: 'Fast Act',
  ...
  },
  {
    ...
    range: Ranges.LOS,
    outOfGame: false,
    description: "Target receives +2 MOve for the rest of teh game. Multiple castings of Fleet Feet on the same target have no effect.",
    starred: false,
  },
  {
    name: 'Petrify',
  ...
  },
  {
    ...
    range: Ranges.SELF,
    outOfGame: false,
    description: "The spellcaster is allowed to activate, with te usual two actions, for a second time in the turn - during the soldier phase. If a spellcaster fails to cast this spell, he suffers 2 damage in addition to any other damage for failing to cast the spell. A spellcaster cannot cast Time Walk if he is current using Time Store.",
    starred: false,
  },
  // Elementalist.
  {
  ...
  },
  {
    ...
    range: Ranges.LOS,
    outOfGame: false,
    description: "The spellcaster chooses an enemy figure within 24\" and line of sight and hurls a ball of destructive elemental eneergy at it. The target, and every figure (including friendly ones) within 1.5\" and line of sight of the target, immedately suffers a +5 shooting attack (roll for each attack separately). This spell may not target an enemy figure that is even partially obscured by anotehr figure.",
  },
  {
    name: 'Elemental Bolt',
    school: Schools.ELEMENTALIST,
  ...
  },
  {
    ...
    range: Ranges.LOS,
    outOfGame: false,
    description: "This spell is cast upon a weapon. the next time this weapon causes at least 1 point of damage, it inflicts an additiona 5 points of damage.",
  },
  {
    ...
    range: Ranges.SELF,
    outOfGame: false,
    description: "The spellcaster forms a floating shield to protect himself. This shield absorbs the next 3 points of damage agains the spellcaster from any source. Once 3 points have been absorbed the shield vanishes. A spellcaster may only have on Elemental Shield active at any time.",
  },
  {
    name: 'Scatter Shot',
    school: Schools.ELEMENTALIST,
    ...
    range: Ranges.AREA,
    outOfGame: false,
    description: "The spellcaster may make one +0 attack against every enemy figure (etierh from an opposing warband or a creature) within 12\". This may includ enemy figures in combat, although the normal rules for shooting into combat are followed in this case.",
  },
  {
    name: 'Wall',
    school: Schools.ELEMENTALIST,
  ...
  },
  {
    ...
    range: Ranges.LOS,
    outOfGame: false,
    description: "If successfully cast, the target construct must make an immediate Will roll versus teh casting roll. If the roll fails, the spellcaster gains control of the construct for the rest of the game. A spellcaster may only control one construct at a time.",
    starred: false,
  },
  {
    ...
    range: Ranges.AREA,
    outOfGame: true,
    description: "This spell casues any Enchant Armor or Enchant Weapon spell that is still active at the end of a game to become permanent, and the weapon or armour in question to become a magic item. Alternatively, a spellcaster may cast either of those spells after a game (even though netierh are usually an Out of Game spell), immedately followed by Embed Enchantment. If both spells are successful, the item becomes permanently enchanted.",
    starred: false,
  },
  {
    name: 'Enchant Armour',
    ...
    range: Ranges.LOS,
    outOfGame: false,
    description: "The armour worn by the target now counts as magic armour and grants a +1 to Armour for the rest of the game. Multiple castings of this spell on the same target have no effect.1`",
    starred: false,
  },
  {
    name: 'Enchant Weapon',
  ...
  },
  {
    ...
    range: Ranges.LOS,
    outOfGame: false,
    description: "The target receives +2 Fight for the rest of the game. Multiple strenth spells o nthe same target have no effect.",
    starred: false,
  },
  {
    name: 'Telekinesis',
    ...
    range: Ranges.LOS,
    outOfGame: false,
    description: "The spellcaster may move any currently unclaimed treasure within 24\" by up to 6\" in any direction. As long as he can maintain line of sight to the treasuire, he can move it over any terrain or obstacle. If the treasure moves out of line of sight, it immedately falls straight to the ground.",
    starred: false,
  },
  // Illusionist.
  {
  ...
  },
  {
    ...
    baseCastingNumber: 10,
    range: Ranges.SELF,
    description: "The spellcaster imemdiately moves to any location within line of sight, but may take no other action this turn. This spell may not be used to enter combat.",
  },
  {
    name: 'Transpose',
    school: Schools.ILLUSIONIST,
    baseCastingNumber: 12,
    range: Ranges.LOS,
    description: "This spell siwtches the position of the two figures on the board. The two figures being transposed must be within 10\" of each other and both must be within line of sight of the spellcaster. The spellcaster may cast Transpose to switch himself with another figure. If he attempts to transpose an enemy figure (either a creature or a member of a rival warband), they may each make a Will roll versus the casting roll. If even one succeeds with this Will roll, the spell fails. this spell may target figures in combat.",
  },
  // Necromancer.
  {
    name: 'test',
